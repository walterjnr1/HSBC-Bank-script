...
$task= $fullname.' '.'Updated Website'.' '. 'On' . ' '.$current_date;
...
<div class="wrapper boxed-wrapper">
 ...
 <?php } ?>
              ...
              <div class="row">
                ...
                <p class="text-left">
				 <label class="control-label">Logo</label>
                   ...
                   <img src="<?php echo $row_website['logo'];   ?>" alt="HSBC bank" width="187" height="66" id="logo-img">				                                   </p>
	 ...
	 <label class="control-label">Favicon</label>
                                ...
                                <p class="text-center">
                    <img src="<?php echo $row_website['favicon'];   ?>" alt="HSBC bank" width="137" height="124" id="logo-favicon">				    </p>
				  </div>		
                <div class="col-md-12">
