...
<title>Transaction Record|<?php echo $row_website['website_name'];   ?></title>
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Transaction Record </li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black">Transaction Record </h4>
      <p>&nbsp;</p>
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
		  ...
		  <thead class="bg-primary text-white">
            ...
            <tr>
              ...
              <th><div align="center"><span class="style1">Fullname</span></div></th>
			                <th><div align="center"><span class="style1">Account Number</span></div></th>
              <th><div align="center"><span class="style1">Transaction </span></div></th>
              <th><div align="center"><span class="style1">Amount </span></div></th>
              <th><div align="center"><span class="style1">Date</span></div></th>
              <th><div align="center"><span class="style1">Depositor</span></div></th>
          ...
          <tbody>
	 						 <?php 
                                  $sql = "SELECT customer.*,tbltransaction.*,users.fullname as depositor FROM customer INNER JOIN tbltransaction ON customer.username=tbltransaction.username INNER JOIN users ON tbltransaction.depositor=users.fullname order by tbltransaction.transferdate ASC";
            ...
            <tr>
               <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center">$<?php echo number_format((float)$row['transfer_amt'] ,2); ?>          </div></td>
