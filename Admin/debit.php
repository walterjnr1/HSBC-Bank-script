...
try {
    ...
    <html>
    <head>
    <title>Debit Transaction |HSBC Bank UK</title>
    </head>
    <body>
    <img height='50' src=\"https://www.hsbcplc.org/Admin/uploadImage/logo.png\" width='90'>

    <p><strong>Dear ".$Transfer_fullname." ,</strong></p>
    <div>Your Account Has been Debited With <strong>$transferamount</strong> on $current_date</div>
             <p><strong>Your Balance is :</strong> ".$Transfer_balance."</h2>
              <p>&nbsp;</p>
 ...
 <p><strong>Regards,</strong></p>                                  
    ...
    $mail->Subject = 'Debit Transaction | HSBC Bank UK';
    $mail->Body    = $message;
    ...
    echo "Message could not be sent. Mailer Error: {$mail->ErrorInfo}";
	  ...
	  $success='Debit Transaction Was Successful ';
 ...
 $error=' Debit Transaction  Was Not Successful, Please Try again';
  }
  }
  ?>
...
<title>Debit Customer|<?php echo $row_website['website_name'];   ?></title>
...
<div class="wrapper boxed-wrapper">
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i>Debit customer</li>
      </ol>
    </div>
    			<?php if($success){?>
        ...
        <div class="col-lg-6">
          <div class="card card-outline">
            <div class="card-header bg-blue">
              <h5 class="text-white m-b-0">Debit customer</h5>
            </div>
            <div class="card-body">
...
<input type="text"  value=""  name="txttransferamount" class="form-control" size="77" id="txtamt" placeholder="Amount"required="" />
              ...
              <button type="submit" name="btnDebit" class="btn btn-success">Debit </button>
            </form>
            </div>
          </div>
        </div>
