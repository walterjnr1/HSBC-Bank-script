...
<title>User Record|<?php echo $row_website['website_name'];   ?></title>
...
<div class="wrapper boxed-wrapper">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black">User Record </h4>
      <p>&nbsp;</p>
        ...
        <table id="example1" class="table table-bordered table-striped">
		  ...
		  <thead class="bg-primary text-white">
            ...
            <tr>
              ...
              <th><div align="center"><span class="style1">Group Name</span></div></th>
              <th><div align="center"><span class="style1">Last Access</span></div></th>
              <th><div align="center"><span class="style1">Last IP Address</span></div></th>
          ...
          <tbody>
            ...
            <tr>
               <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        ...
                        <td><div align="center"><?php echo $row['lastaccess']; ?></div></td>
                        <td><div align="center"><?php echo $row['last_ip']; ?></div></td>
                        
			
                        <td>
                        <div align="center">
                           
                        <a href="delete-user.php?id=<?php echo $row['username'];?>" ><i class="fa fa-times" title="Delete User Record"></i> </a> </div></td>
                      </tr>
                      <?php $cnt=$cnt+1;} ?>
