          ...
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="../Admin/<?php echo $row_cust['photo']; ?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo $row_cust['fullname']; ?>  </span> </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p class="text-left"><?php echo $row_cust['fullname']; ?>  <small><?php echo $row_cust['email']; ?> </small> </p>
              </li>
...
$stmt = $dbh->prepare("SELECT * FROM customer where username=?");
                ...
                <div class="table-responsive">
                  <div align="center">
                    <table width="114%" height="87" class="table table-hover">
                      ...
                      <tbody>
					    <?php 
$data = $dbh->query("SELECT * FROM fake_transaction ORDER BY transferdate DESC LIMIT 20")->fetchAll();
$cnt=1;
foreach ($data as $row) {
